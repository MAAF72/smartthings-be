...
public class TranslationServiceImpl implements TranslationService {
  ...
  private static final TranslationService transaltorService = buildTranlationService();

  private static TranslationService buildTranlationService() {
    return new TranslationServiceImpl();
  }
  
  @Produces
  public static TranslationService getTranslationService() {
    return transaltorService;
  }
